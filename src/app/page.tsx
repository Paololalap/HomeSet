            ...
            <Grid2 container spacing={2.5}>
              ...
              <Grid2>
                <Typography fontFamily={"Lato"} color={"black"}>
                  It can be uncomfortable inviting strangers into your home, so
                  let&#39;s get acquainted - here a few examples of the talented
                  people we have on our team!
                </Typography>
                <Typography fontFamily={"Lato"} color={"black"} mt={"1rem"}>
                  We train our painters from apprentice to seasoned veteran, to
                  ensure that we always deliver the highest quality paint work
                  in your home.
                </Typography>
              </Grid2>
